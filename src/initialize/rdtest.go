...
/*
#cgo LDFLAGS: -L ./nist_sts/build/nist_sts -lnist_sts -lm
#include "./nist_sts/nist_sts/include/stat_fncs.h"
*/
import "C"
import (
	"fmt"
...
// 上电检测
func RandomPowerOnDetection(filepath string) ([15]int, *b.StdErr) {
	var passnums [15]int
	...
	fmt.Println("\033[32mRandomPowerOnDetection Success\033[0m")
	return passnums, nil
}

// 周期检测
func RandomCycleDetection(filepath string) ([12]int, *b.StdErr) {
	var passnums [12]int
	...
	fmt.Println("\033[32mRandomCycleDetection Success\033[0m")
	return passnums, nil
}
